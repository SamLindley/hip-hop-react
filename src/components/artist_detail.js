...
class ArtistDetail extends Component {
    ...
    render() {
        console.log(this.props.newArtistSelected);
                ...
                <Collapse isOpen={this.handleArtistSelected()}>
                    <div className="artist-detail-content container">
                        ...
                        <div className="row" id="artist-container">
                            <div className="col-md-6 col-lg-6">
                                <div className="pull-left"><img style={{borderColor: this.props.artist.hexColor}}
                                                                id="artistPicture" src={this.props.artist.imageUrl}/>
                                </div>
                                <div id="artist-bio"><p>
                        ...
                        <div id="info-button-container">
                            <button id="infoButton" className="btn btn-info" onClick={() => this.toggleInfoBar()}>More
                                Info
                            </button>
                        </div>
                        ...
                        <div id="buttonContainer">
                            <button id="voteButton" className="btn btn-info" onClick={() => this.toggleVoteBar()}>Vote
                            </button>
                        </div>
